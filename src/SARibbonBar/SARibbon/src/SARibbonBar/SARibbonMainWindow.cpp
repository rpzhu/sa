...
void
SARibbonMainWindowPrivate::init()
{
#if 0
...
const SARibbonBar*
SARibbonMainWindow::ribbonBar() const
{
    return m_d->ribbonBar;
}

SARibbonBar*
SARibbonMainWindow::ribbonBar()
{
    return m_d->ribbonBar;
}

void
SARibbonMainWindow::setRibbonTheme(SARibbonMainWindow::RibbonTheme theme)
{
    switch (ribbonTheme()) {
    case NormalTheme:
...
SARibbonMainWindow::RibbonTheme
SARibbonMainWindow::ribbonTheme() const
{
...
void
SARibbonMainWindow::resizeEvent(QResizeEvent* event)
{
    if (m_d->ribbonBar) {
...
bool
SARibbonMainWindow::eventFilter(QObject* obj, QEvent* e)
{
...
void
SARibbonMainWindow::loadTheme(const QString& themeFile)
{
