...
SAMainWindowPrivate::SAMainWindowPrivate(SAMainWindow* p)
  : q_ptr(p)
...
SAMainWindow::SAMainWindow(QWidget* parent, Qt::WindowFlags flags)
...
QDateTime
SAMainWindow::getBirthDate()
{
    return d_ptr->m_birthdate;
}

QString
SAMainWindow::getBirthDateString(Qt::DateFormat f)
{
    return d_ptr->m_birthdate.toString(f);
}

void
SAMainWindow::setBirthDate(const QDateTime& s)
{
    d_ptr->m_birthdate = s;
}

void
SAMainWindow::setHidden()
{
    hide();
...
int
SAMainWindow::getID() const
{
    return (intptr_t)this;
}

void
SAMainWindow::closeEvent(QCloseEvent* e)
{
...
void
SAMainWindow::askOnCloseEvent(bool ask)
{
    d_ptr->m_confirm_close = ask;
}

bool
SAMainWindow::eventFilter(QObject* object, QEvent* e)
{
